...
(function () {
    ...
    class Search extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$5, safe_not_equal, { query: 1, filters: 2 });
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*text*/ 1 && raw_value !== (raw_value = marked(/*text*/ ctx[0]) + "")) div.innerHTML = raw_value;		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    			if (detaching) detach(div);
    ...
    class Article extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$2, safe_not_equal, { text: 0 });
    	}
    }
