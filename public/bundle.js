...
(function (marked) {
    ...
    class Search extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$4, safe_not_equal, { query: 1, filters: 2 });
    	}
    ...
    function create_fragment$1(ctx) {
    	let div;
    	let raw_value = marked.marked(/*text*/ ctx[0]) + "";
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*text*/ 1 && raw_value !== (raw_value = marked.marked(/*text*/ ctx[0]) + "")) div.innerHTML = raw_value;		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    			if (detaching) detach(div);
    ...
    // (15:2) <Route path="search/:query/:filters" let:params>
