...
(function () {
    ...
    class Router extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$5, safe_not_equal, { basepath: 3, url: 4 });
    	}
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			main = claim_element(header_nodes, "MAIN", {});
    			var main_nodes = children(main);
    			img = claim_element(main_nodes, "IMG", { src: true, alt: true });
    ...
    function create_default_slot_1(ctx) {
    	...
    	return {
    		c() {
    			create_component(personnes.$$.fragment);
    		},
    		l(nodes) {
    			claim_component(personnes.$$.fragment, nodes);
    		},
    		m(target, anchor) {
    			mount_component(personnes, target, anchor);
    			current = true;
    		},
    		i(local) {
    			if (current) return;
    			transition_in(personnes.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(personnes.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(personnes, detaching);
    		}
    	};
    }
