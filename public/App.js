...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<header><main><form><input type="${"text"}" placeholder="${"Recherchez"}">
          <button type="${"button"}">🔎</button></form></main></header>`;
});
...
${validate_component(Router, "Router").$$render($$result, { url }, {}, {
		default: () => `${validate_component(Route, "Route").$$render($$result, { path: "debug", component: Debug }, {}, {})}`
	})}`;
});
