...
const Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div>${each(reqdata, dat => `<div><h1>${escape$1(dat.title)}</h1>
...
const css$1 = {
	...
	map: "{\"version\":3,\"file\":\"Header.svelte\",\"sources\":[\"Header.svelte\"],\"sourcesContent\":[\"<script>\\r\\n  import SearchBar from \\\"./SearchBar.svelte\\\";\\r\\n</script>\\r\\n\\r\\n<header>\\r\\n    <img\\r\\n     src=\\\"img/corsaire.png\\\"\\r\\n     alt=\\\"logo corsaire dunkerquois\\\">\\r\\n        <form>\\r\\n        </form>\\r\\n</header>\\r\\n\\r\\n<style>\\r\\n  header {\\r\\n\\tbackground-color: rgb(2, 18, 43);\\r\\n\\tmargin : 0;\\r\\n}\\r\\n</style>\\r\\n\"],\"names\":[],\"mappings\":\"AAaE,MAAM,cAAC,CAAC,AACT,gBAAgB,CAAE,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAChC,MAAM,CAAG,CAAC,AACX,CAAC\"}"
};

const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css$1);

	return `<header class="${"svelte-hlqhou"}"><img src="${"img/corsaire.png"}" alt="${"logo corsaire dunkerquois"}">
        <form></form>
</header>`;
});
