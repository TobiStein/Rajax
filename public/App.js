...
const css = {
	code: "p.svelte-4eyucy{color:white}",
	map: "{\"version\":3,\"file\":\"EasterEgg.svelte\",\"sources\":[\"EasterEgg.svelte\"],\"sourcesContent\":[\"<p> TEST</p>\\r\\n\\r\\n<style>\\r\\n    p{\\r\\n        color: white;\\r\\n    }\\r\\n</style>\"],\"names\":[],\"mappings\":\"AAGI,eAAC,CAAC,AACE,KAAK,CAAE,KAAK,AAChB,CAAC\"}"
};

const EasterEgg = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css);
	return `<p class="${"svelte-4eyucy"}">TEST</p>`;
});
...
const Article = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div>${marked.marked(text)}</div>`;
});
